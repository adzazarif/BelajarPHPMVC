            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <form class="d-flex" action="<?= BASEURL ?>/admin/searchClient" method="POST">
                  <input
                    type="text"
                    autocomplete="off"
                    name="keywoard"
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-success" href="<?= BASEURL ?>/admin/detailClient/<?= $d['clientId'] ?>" role="button">Details</a>
                          </td>
                        </tr>
                        <?php $no++; endforeach ?>
                    </tbody>
