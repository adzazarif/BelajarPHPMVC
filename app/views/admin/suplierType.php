...
<div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= BASEURL ?>/admin/addSuplierType" method="POST">
      <div class="modal-body">
        ...
        <div class="mb-3">
                        <label for="defaultSelect" class="form-label">Suplier Markup</label>
                        <select id="defaultSelect" name="markupId" class="form-select">
                            <?php foreach($data['dataMarkup'] as $d): ?>
                          <option value="<?= $d['suplierMarkupId'] ?>"><?= $d['suplierMarkupName'] ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
